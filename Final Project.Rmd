...
fviz_nbclust(RatiosScaled, hcut, hc_method = "complete", hc_metric = "euclidean", method = "wss")
```
...
eu_dist <- get_dist(RatiosScaled, method = 'euclidean') 
hc_complete <- hclust(eu_dist, method = 'complete') 
hc <- cutree(hc_complete, k = 3)
```
